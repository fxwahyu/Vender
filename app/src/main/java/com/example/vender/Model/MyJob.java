...
public class MyJob implements Serializable {
    ...
    private String nama_event, deskripsi, kota, venue, tanggal_event, foto, status, lowongan, min_fee, max_fee, phonenumber;

    public MyJob(){

    }

    public MyJob(int id, int user_id, String nama_event, String deskripsi, String kota,
                 String venue, String tanggal_event, String foto,
                 String status, String lowongan, String min_fee, String max_fee, int rating, String phonenumber) {
        this.id = id;
