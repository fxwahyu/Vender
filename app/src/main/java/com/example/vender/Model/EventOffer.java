...
public class EventOffer implements Serializable {
    private int id, user_id, offer_id;
    private String nama_event, deskripsi, kota, venue, tanggal_event, foto, status, lowongan, min_fee, max_fee, phonenumber, offer_status;

    public EventOffer(int id, int user_id, int offer_id, String nama_event, String deskripsi,
                      String kota, String venue, String tanggal_event, String foto, String status
            , String lowongan, String min_fee, String max_fee, String phonenumber, String offer_status) {
        this.id = id;
