...
public class FragmentOffer_Hire extends Fragment {
    private View view;
    private List<Talent> talentList;
    private List<TalentOffer> talentOfferList;
    private static String URL_HIREOFFERLIST = "https://venderapp.000webhostapp.com/hireofferlist.php";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.list_offer_hire, container, false);
        talentList = new ArrayList<>();
        talentOfferList = new ArrayList<>();
        kosong = (TextView) view.findViewById(R.id.kosong);
        user = g.getUser();
        rv = (RecyclerView) view.findViewById(R.id.rv_offer_hire);

        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_HIREOFFERLIST, new Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    if (success.equals("1")) {
                        for (int i = 0; i < jsonArray.length(); i++){
                            ...
                            TalentOffer talentOffer = new TalentOffer(offerid, eventid, talentid, rating, numberofjobs, namaevent, namatalent, phonenumber, skill, bio, kota, min_fee, max_fee, experience, "waiting", instagram, youtube, foto);
                            talentOfferList.add(talentOffer);
                        }

                        RecyclerView myrv = (RecyclerView) view.findViewById(R.id.rv_offer_hire);
                        Adapter_Hire myAdapter = new Adapter_Hire(getActivity(), talentOfferList);
