...
public class Adapter_Recruiting extends RecyclerView.Adapter<Adapter_Recruiting.ViewHolder> {
    private Context context;
    private List<TalentOffer> talentOfferList;

    public Adapter_Recruiting(Context context, List<TalentOffer> talentOfferList) {
    ...
    @NonNull
    @Override
    public Adapter_Recruiting.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view;
        LayoutInflater inflater = LayoutInflater.from(context);
        view = inflater.inflate(R.layout.item_submission_recruiting, viewGroup, false);
        return new Adapter_Recruiting.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_Recruiting.ViewHolder viewHolder, final int i) {
        viewHolder.namatalent.setText(talentOfferList.get(i).getNamatalent());
        viewHolder.status.setText(talentOfferList.get(i).getOfferstatus());
        if (talentOfferList.get(i).getOfferstatus().equals("accepted")) viewHolder.status.setTextColor(context.getResources().getColor(R.color.active));
        else if (talentOfferList.get(i).getOfferstatus().equals("rejected")) viewHolder.status.setTextColor(context.getResources().getColor(R.color.nonactive));
        ...
        viewHolder.constraintLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("dari", "submission");
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ImageView image;
        TextView namatalent, namaevent, status;
